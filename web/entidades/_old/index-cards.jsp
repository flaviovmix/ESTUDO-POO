        ...
        <main>
           <%@ include file="interface/navbar.html" %>
            ...
            <div class="container-xl"> 
                ...
                <symbol id="music-note-beamed2" viewBox="0 0 16 16">
